...
var RedisProxy = module.exports = function(o){
  ...
  var onDown = function onDown(){
    stats.incr("down:"+ this.host+":"+ this.port);
    if(_.isEqual(self._active.options, this.options)){
      stats.incr("down:master");
