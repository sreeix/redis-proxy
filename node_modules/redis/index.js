...
RedisClient.prototype.sendRaw = function(command_str, callback){
...
RedisClient.prototype.send_command = function (command, args, callback) {
    var arg, command_obj, i, il, elem_count, stream = this.stream, buffer_args, command_str = "", buffered_writes = 0, last_arg_type;
    ...
    command_obj = new Command(command, args, false, false, callback);
